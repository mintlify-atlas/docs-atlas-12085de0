...
Pixi's import capabilities are actively being developed. Track progress:

- [Import roadmap issue on GitHub](https://github.com/prefix-dev/pixi/issues/4192)
- More import formats coming soon
- Enhanced Poetry/PDM integration planned